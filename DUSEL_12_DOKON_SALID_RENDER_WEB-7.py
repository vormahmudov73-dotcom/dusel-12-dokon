...
def seed_salid_light_products():
    """SALID -> SALID LIGEHT bo'limiga SG va SN bo'limlarini avtomatik qo'shadi."""
    ...
    sg_products = [
        ("SG01-10 white", 5.00),
        ("SG01-10 black", 5.00),
        ("SG02-10 white/black", 3.20),
        ("SG03-7 white/black", 5.00),
        ("SG04-10 white/black", 5.70),
        ("SG04-10/2 white/black", 11.00),
        ("SG04-10/3 white/black", 17.00),
    ]
